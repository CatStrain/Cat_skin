...
void loop() {
  ...
  adc0 = ads1015_3.readADC_Differential_0_1();                  //read difference between 0 and 1 input on first amplifier
  Serial.println(adc0);

  adc1=ads1015_3.readADC_Differential_2_3(); 
  Serial.println(adc1);
   
  adc2=ads1015_4.readADC_Differential_0_1(); 
  Serial.println(adc2);
  
  adc3=ads1015_4.readADC_Differential_2_3(); 
  Serial.println(adc3);  
