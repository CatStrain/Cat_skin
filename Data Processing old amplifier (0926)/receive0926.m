...
strain_gauge_lecture = 800; %read 100 numbers from arduino. can be adjusted. 
...
writematrix(data_2,'test0926_B4_10.txt'); %we change to this because we have the datamatrix ready
